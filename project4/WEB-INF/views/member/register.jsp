...
<body>
	...
	<div class="container">
		...
		<hr />
		<div class="content">
			<form action="/member/registery" method="post" id="regForm" name="vo"
				onsummit="return regData(this)">
				<div class="form-group has-feedback">
					<label class="control-label" for="userId">아이디</label> <input
						class="form-control" type="text" id="userId" name="userId"
						required />
					<button class="idChkBtn" type="button" id="idChkBtn"
