...
<html>
	<head>
		...
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap-theme.min.css">
	 	...
	 	<style type="text/css">
	 	.cont { min-height: 200px; min-width: 400px;}
	 	</style>
	 	<title>게시판</title>
				...
				<form name="updateForm" role="form" method="post" action="/board/update" enctype="multipart/form-data">
					...
					<table id="table">
						<tbody>
							...
							<tr>
								<td>
									<label for="content">내용</label><textarea id="content" name="content" class="cont" title="내용을 입력하세요."><c:out value="${update.content}" /></textarea>
								</td>
							</tr>
							<tr>
								<td>
