	...
	<table class="tb">
		<tbody>
			...
			<tr>
				...
				<td class="col_data">
					<input type="text" id="title" name="title" class="in_data" value="<%=noti.getTit() %>"  required />
				</td>
			</tr>
			<tr>
				<th class="col_hd">
			...
			<tr>
				...
				<td class="col_data">
					<input type="text" id="author" name="author" class="in_data" value="<%=noti.getAut() %>" required/>
				</td>
			</tr>
			<tr>
				<th class="col_hd">
				...
				<td class="col_data">
					<input type="text" id="resdate" name="resdate" class="in_data" value="<%=noti.getRdate() %>" readonly />
				</td>
			</tr>
			<tr>
				<th class="col_hd">
