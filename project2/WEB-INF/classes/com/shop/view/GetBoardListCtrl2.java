...
//글목록 보기
@WebServlet("/GetBoardListCtrl2")
public class GetBoardListCtrl2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("./board/getBoardList2.jsp");	//보내질 곳 선언
