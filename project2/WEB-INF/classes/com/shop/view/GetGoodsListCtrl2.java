...
@WebServlet("/GetGoodsListCtrl2")
public class GetGoodsListCtrl2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view =request.getRequestDispatcher("/goods/getGoodsList2.jsp");
