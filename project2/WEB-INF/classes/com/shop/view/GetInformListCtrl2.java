...
@WebServlet("/GetInformListCtrl2")
public class GetInformListCtrl2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view =request.getRequestDispatcher("/inform/getInformList2.jsp");
