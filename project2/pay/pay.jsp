...
<%
	GoodsVO goods = (GoodsVO)application.getAttribute("goods");
	
	String gcode = request.getParameter("gcode");
	int num = 1;
	num = (int) session.getAttribute("num");	//수량
	int price = 1;
	price = (int) session.getAttribute("gprice");	//가격
	
	
	/*String cusid = (String) session.getAttribute("cusid");*/	//아이디
	 ...
	 <h2 class="tit">결제페이지</h2>
		...
		<table class="table">
			<tr>
				...
				<td><input type="text" name="cusid" value="<%=cusid %>" readonly/>
				</td>
			</tr>
			<tr>
				<th><label for="">결제자 이름</label></th>
				<td >
					<input type="text" name="name" id="email" value="<%=cusname %>"/></td>
			</tr>
			<tr>
				<th><label for="">전화번호</label></th>
				<td>
				<input type="text" name="custel" id="custel" value="<%=custel %>"/></td>
			</tr>
			<tr>
				<th><label for="email">이메일</label></th>
				<td>
				<input type="text" name="email" id="email" autofocus required /></td>
			</tr>
			<tr>
				<th><label for="zipcode">우편번호</label></th>
					<td><input type="text" name="zipcode" id="zipcode" required />
			...
			<tr>
					...
					<td>
							...
							<input type="text" name="add2" id="add2" required /><br>
					</td>
				</tr>
			<tr>
				<th><label for="">배송시 참고사항</label></th>
				<td>
				<input type="text" name="contact" id="contact" required /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
				<input type="text" name="gcnt" id="gcnt" value="<%=num %>" readonly/></td>
			</tr>
			<tr>
