...
@WebServlet("/GetBulletinCtrl2")
public class GetBulletinCtrl2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bulletinList != null) {
			...
			RequestDispatcher view = request.getRequestDispatcher("/Bulletin/GetBulletin2.jsp");
