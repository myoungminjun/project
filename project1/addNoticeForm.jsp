	...
	<table class="tb">
		<tbody>
			<tr>
				...
				<td class="col_data">
					<input type="text" id="nid" name="nid" class="in_data" value="<%=num2 %>" required readonly />
				</td>
			</tr>
			<tr>
				<th class="col_hd">
				...
				<td class="col_data">
					<input type="text" id="tit" name="tit" class="in_data"  required />
				</td>
			</tr>
			<tr>
				<th class="col_hd">
					<label for="con">글 내용</label>
				</th>
				<td class="col_data">
					<textarea id="con" name="con" class="in_data_area"  cols="60" rows="15" required>
					</textarea>
				</td>
			</tr>
			<tr>
				<th class="col_hd">
					<label for="aut">작성자</label>
				</th>
				<td class="col_data">
					<input type="text" id="aut" name="aut" class="in_data" value="관리자" required/>
				</td>
			</tr>
		</tbody>
	</table>
