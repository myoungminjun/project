	...
	<table class="tb">
		<tbody>
			...
			<tr>
				...
				<td class="col_data">
					<input type="text" id="uregdate" name="uregdate" class="in_data" value="<%=mem.getRegdate() %>"/>
				</td>
			</tr>
			<tr>
				<th class="col_hd">
			...
			<!--<tr>
				...
				<td class="col_data">
					...
					%>		
						<input type="checkbox" id="uyesno" name="uyesno" checked value="no"/>
					<%			
						} else {
					%>
						<input type="checkbox" id="uyesno" name="uyesno" value="yes"/>
					<%		
						}
					 %>
					 </span>
